...
def SaveImg():
  global counter, part_num, axis_points_1, axis_points_2, axis_points, object_name, aruco_pos1, aruco_orient1, aruco_pos2, aruco_orient2
  ...
  if(part_num == 1):
    ...
    part_num = 2
    PC = CreatePointCloud('files_ArUco/images/rgb_img_I/arucoRGB%05d.png'%counter, 'files_ArUco/images/depth_img_I/arucoD%05d.npy'%counter)
